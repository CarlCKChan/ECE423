...
entity cpu_0_2d_interface9_inst is
	port (
		clk    : in  std_logic                     := '0';             -- custom_instruciton_slave.clk
...
end entity cpu_0_2d_interface9_inst;

architecture rtl of cpu_0_2d_interface9_inst is
...
begin
	...
	cpu_0_2d_interface9_inst : component custominstruction_2d
		port map (
			clk    => clk,    -- custom_instruciton_slave.clk
			reset  => reset,  --                         .reset
...
end architecture rtl; -- of cpu_0_2d_interface9_inst

...
parameter WIDTH_IN				= 280; // Incoming frame's width in pixels
parameter HEIGHT_IN				= 200; // Incoming frame's height in lines
parameter WW_IN					= 8; // Incoming frame's width's address width
...
parameter ADD_PIXELS_AT_START	= 20;
parameter ADD_PIXELS_AT_END		= 20;
parameter ADD_LINES_AT_START	= 20;
parameter ADD_LINES_AT_END		= 20;
...
defparam	Clipper_Drop.DW						= DW,
			Clipper_Drop.WIDTH					= EW,

			Clipper_Drop.WIDTH					= WIDTH_IN,
			Clipper_Drop.HEIGHT					= HEIGHT_IN,
...
defparam	Clipper_Add.DW					= DW,
			Clipper_Add.WIDTH				= EW,

			Clipper_Add.WIDTH				= WIDTH_OUT,
			Clipper_Add.HEIGHT				= HEIGHT_OUT,

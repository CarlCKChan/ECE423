...
module video_pixel_buffer_dma_0 (
	// Inputs
	clk,
	reset,
...
// Parameters
parameter DEFAULT_BUFFER_ADDRESS	= 32'd17301504;
parameter DEFAULT_BACK_BUF_ADDRESS	= 32'd17563648;
...
parameter PIXELS					= 280; // Image width - number of pixels
parameter LINES 					= 200; // Image height - number of lines
	...
	STATE_0_IDLE:
		begin
			if (fifo_almost_empty)
				next_state = STATE_2_READ_BUFFER;
			else
	...
	STATE_1_WAIT_FOR_LAST_PIXEL:
		begin
			if (pending_reads == 4'h0) 
				...
				next_state = STATE_1_WAIT_FOR_LAST_PIXEL;
		end
	STATE_2_READ_BUFFER:
		begin
			...
			begin
				if (pixel_address == ((PIXELS * LINES)  - 1))
					...
					next_state = STATE_3_MAX_PENDING_READS_STALL;
				else
					next_state = STATE_2_READ_BUFFER;
			end
			else
...
begin
	...
	else if ((present_state == STATE_0_IDLE) &
			(pixel_address == 'h0))
...
begin
	...
	begin
		if (pixel_address == ((PIXELS * LINES)  - 1))
			...
			pixel_address <= pixel_address + 'h1;
	end
end
...
assign fifo_data_in[DW+2]	= (present_state == STATE_1_WAIT_FOR_LAST_PIXEL) & 
								(pending_reads == 4'h1);
